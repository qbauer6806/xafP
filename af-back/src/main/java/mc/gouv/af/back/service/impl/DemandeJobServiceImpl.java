...
import mc.gouv.af.back.service.transformer.JobTransformer;
import mc.gouv.af.data.dao.DemandeJobRepository;
import mc.gouv.af.data.entity.DemandeJobBO;
import mc.gouv.af.data.enums.JobNamesEnum;
import mc.gouv.af.data.enums.JobStatutsEnum;
...
public class DemandeJobServiceImpl implements DemandeJobService {
    ...
    public Page<JobDTO> list(Pageable pageable) {
        ...
        return JobTransformer.bo2Dto(jobs);
    }
