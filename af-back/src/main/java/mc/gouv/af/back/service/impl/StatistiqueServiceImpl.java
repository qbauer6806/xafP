...
import mc.gouv.af.back.stats.StatistiquesService;
import mc.gouv.dem.service.DemandesStatistiquesService;
...
@Component
public class StatistiqueServiceImpl implements StatistiquesService {
