...
public interface HistoService {
    ...
    public DemandeHistoriqueDTO statusChange(Integer demandeId, DemandeStatutEnum targetState, String customContextParam, Integer usagerId,
            String agentId);

    public DemandeHistoriqueDTO prendreEnCharge(Integer demandeId, DemandeStatutEnum targetState, String agentId);

    public DemandeHistoriqueDTO reponseDemandeCompl(Integer demandeId, DemandeStatutEnum targetState, Integer usagerId, String agentId);
