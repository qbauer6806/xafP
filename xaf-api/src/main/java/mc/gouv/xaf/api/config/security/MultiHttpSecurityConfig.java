...
public class MultiHttpSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtDecoder jwtDecoder) throws Exception {
        http.securityMatcher("/api/v1/paiement/tarif", "/api/v1/paiement/debit", "/api/v1/paiement/statutCaisse")
                .authorizeHttpRequests(auth -> {
                    auth.requestMatchers("/api/v1/paiement/tarif", "/api/v1/paiement/debit", "/api/v1/paiement/statutCaisse").authenticated();
                })
