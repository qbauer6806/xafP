package mc.gouv.xaf.apiclient.stc;
...
public class StcApiClient extends AfApiClient {
     ...
     */
    public StcApiClient(String serviceUrl, String jwtToken) {
        super(serviceUrl, jwtToken);
    }

    public PaiementDTO getPaiement(Integer demandeId, String langue, Integer usagerId) {
        Response res = getTarget().path("/paiement")
                .queryParam("demandeId", demandeId)
