...
var generateURI = function (form, pdfType) {
    return APP.getContextPath() + '/ws/pdf/apercu?pkDemande=' + form.pkDemande + '&statut=' + form.statutChoisi + '&texteAEnvoyer='
        + encodeURIComponent(form.texteAEnvoyer) + '&commentaire=' + encodeURIComponent(form.commentaire) + '&codeMotif='
...
function createPdfCanvas(containerId, currPage, numPages, thePDF, page) {
    ...
    if (thePDF !== null && currPage <= numPages) {
        return thePDF.getPage(currPage).then(createPdfCanvas.bind(null, containerId, currPage, numPages, thePDF));
    }
}
