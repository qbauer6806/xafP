...
public enum OuinonEnum {
    ...
    private OuinonEnum(String libelle, String originalName, String camelName) {
    ...
    @JsonCreator
    public static OuinonEnum forValue(String value) {
	return forValue(value, false);
    }

    public static OuinonEnum forValue(String value, boolean choixMultiple) {
        for (OuinonEnum checkEnum : values()) {
