...
public class ResidAdresseDTO implements Serializable {
	...
	private static final long serialVersionUID = -7470288528228171452L;
	...
	public String toString() {
		return "ResidAdresseDTO{" + "careOf='" + careOf + '\'' + ", adresse1='" + adresse1 + '\'' + ", adresse2='"
				+ adresse2 + '\'' + ", adresse3='" + adresse3 + '\'' + ", adresse4='" + adresse4 + '\'' + ", paysCode='"
				+ paysCode + '\'' + ", bloc='" + bloc + '\'' + ", etage='" + etage + '\'' + ", appartement="
				+ appartement + '}';
	}
