...
public class PaiementPropertiesResolverImpl implements PaiementPropertiesResolver {
    ...
    @Value("mc.gouv.${application.name}.cir.serviceUrl")
    private String cirServiceUrl;

    @Value("mc.gouv.${application.name}.cir.token")
    private String cirServiceToken;

    @Value("mc.gouv.${application.name}.cir.registre:0")
    private String cirRegistre;

    @Value("mc.gouv.${application.name}.cir.permis:0")
    private String cirPermis;

    @Value("mc.gouv.${application.name}.cir.immat:")
    private String cirImmat;

    @Value("mc.gouv.${application.name}.monetico.currency")
    private String moneticoCurrency;

    @Value("mc.gouv.${application.name}.monetico.tpe")
    private String moneticoTpe;

    @Value("mc.gouv.${application.name}.monetico.cleSceau")
    private String moneticoCleSceau;

    @Value("mc.gouv.${application.name}.monetico.versionAller")
    private String moneticoVersionAller;

    @Value("mc.gouv.${application.name}.monetico.versionCapture")
    private String moneticoVersionCapture;

    @Value("mc.gouv.${application.name}.monetico.codeSiteStandard")
    private String moneticoCodeSiteStandard;

    @Value("mc.gouv.${application.name}.monetico.codeSiteIframe")
    private String moneticoCodeSiteIframe;

    @Value("mc.gouv.${application.name}.monetico.captureUrl")
    private String moneticoCaptureUrl;

    @Value("mc.gouv.${application.name}.monetico.successUrl")
    private String moneticoSuccessUrl;

    @Value("mc.gouv.${application.name}.monetico.echecUrl")
