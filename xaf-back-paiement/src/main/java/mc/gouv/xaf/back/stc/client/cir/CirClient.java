...
public class CirClient implements FactureClient {
    ...
    private final CirPropertiesResolver cirPropertiesResolver;

    public CirClient(UsagersCache usagersCache, Proxy proxy, CirPropertiesResolver cirPropertiesResolver) {
        String serviceUrl = cirPropertiesResolver.getUrl();
        ...
        this.cirPropertiesResolver = cirPropertiesResolver;
    }
    ...
    public String check(String numFacture) {
        ...
        Response response = this.targetCheck.queryParam("numFacture", numFacture)
                .queryParam("registre", cirPropertiesResolver.getRegistre())
                .queryParam("codeTarif", cirPropertiesResolver.getCodeTarif())
                .request()
                .header(HttpHeaders.AUTHORIZATION, BEARER_PREFIX + cirPropertiesResolver.getToken())
                .get();
    ...
    public String createFacture(String numPermis, String numImmat, double montant, String codeTransaction, Integer usagerId) {
        ...
        request.setNumTpe(cirPropertiesResolver.getTpe());
        ...
        request.setRegistre(cirPropertiesResolver.getRegistre());
        ...
        request.setCodeOperation(cirPropertiesResolver.getCodeTarif());
