...
public interface AccessRepository extends CrudRepository<AccessBO, Integer> {
    ...
    /**
     * Retourne les accès correspondant à ce demarcheId et cet usagerId Normalement il n'y en a un seul en base qui
     * correspond à ce couple (demarcheId,usagerId) et qui ait Active = true Sinon cela signifie que la DB est dans un
     * état incohérent
     */
