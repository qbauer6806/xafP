...
public interface AccessRepository extends CrudRepository<AccessBO, Integer> {
     ...
     * @return
     */
    public List<AccessBO> getByDemarcheIdAndUsagerIdAndActive(String demarcheId, Integer usagerId, boolean active);
    
    public List<AccessBO> getByDemarcheIdAndActive(String demarcheId, boolean active);
    
    public List<AccessBO> getByDemarcheId(String demarcheId);
