...
/**
 * Permet à un TS d'implémenter une ou plusieurs façons différentes de retourner des demandes à partir d'un critère de
 * date ou de statut (pour l'export Excel par exemple)
 *
 * Exemple :
