...
public class DemandesServiceImpl implements DemandesService {
    ...
    public DemandeDTO saveDemande(DemandeDTO demande, String premierStatut) throws IOException {
        ...
        try {
            ...
            DemandePostprocessingService dps = (DemandePostprocessingService) appContext
                    .getBean("DemandePostprocessingServiceImplV" + demande.getBuildId());
    ...
    public List<DemandeDTO> getAllDemandesFilteredByStatutAndDateDernierStatut(String statut, Date date) {
        List<DemandeBO> demandes = demandesRepository.findAllByDernierStatut_LibelleAndDernierStatutDateLessThan(statut,
                date);
        LOGGER.info(SharedMessages.TRANSFORMATION_BO_DTO);
        return DemandesTransformer.bo2Dto(demandes);
    }
    ...
    private Predicate genererPredicate(DemandeRechercheDTO demandeRecherche, Root<DemandeBO> root,
    ...
    private CriteriaQuery<DemandeBO> createQuery(DemandeRechercheDTO demandeRecherche, CriteriaQuery<DemandeBO> cquery,
            Root<DemandeBO> root, CriteriaBuilder builder) {
