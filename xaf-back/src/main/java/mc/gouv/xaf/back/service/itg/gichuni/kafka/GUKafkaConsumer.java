...
public class GUKafkaConsumer {
    ...
    private final GUKafkaEventListener guKafkaEventListener;
    ...
    public void listen(ConsumerRecord<String, Object> consumerRecord) {
        ...
        if ("desinscription-usager-gichuni".equals(genericMessage.getType()) && "v1".equals(
                genericMessage.getVersion())) {
            try {
                mc.gouv.xaf.back.service.itg.gichuni.kafka.dto.v1.DesinscriptionUsagerGUMessage message = mapper.readValue(
                        messageStr,
