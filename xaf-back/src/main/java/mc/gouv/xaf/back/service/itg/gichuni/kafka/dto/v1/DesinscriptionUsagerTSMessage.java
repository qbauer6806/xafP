 ...
 *
 * Lorsqu'un usager se désinscrit d'un TS, le TS envoie un message au GU afin qu'il mette à jour sa liste de
 * correspondance entre les usagers et les TS sur lesquels ils sont inscrits.
 *
 * @author qdeme
 */
