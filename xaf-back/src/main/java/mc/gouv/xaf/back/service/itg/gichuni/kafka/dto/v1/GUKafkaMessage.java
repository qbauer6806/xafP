...
public class GUKafkaMessage extends GUGenericKafkaMessage {
    ...
    /**
     * Informations de second niveau, pouvant dépendre d'une version de message : pour le moment aucune (avant "type"
     * était ici, avant d'être remonté plus haut à côté de "version").
     */
