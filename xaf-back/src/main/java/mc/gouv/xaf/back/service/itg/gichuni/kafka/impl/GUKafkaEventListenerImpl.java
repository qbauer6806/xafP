...
import mc.gouv.xaf.back.service.AbstractAfApiService;
...
public class GUKafkaEventListenerImpl implements GUKafkaEventListener {
	...
	@Autowired
	private AbstractAfApiService afApiService;
	...
	public void desinscriptionUsagerGuichetUnique(GUKafkaMessage message) {
		...
		if ("v1".equals(message.getVersion())) {
			...
			LOGGER.info("L'usager {} s'est désinscrit du Guichet Unique. Lancement de la désinscription dans le TS...", desin.getUsagerId());
