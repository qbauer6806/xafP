...
public interface MailService {
	 ...
	 * @param pkDemande clé primaire de la demande
	 ...
	 */
	void sendMailSupport(String subjectTemplateCode, String bodyTemplateCode, Set<String> mailingLists, Integer pkDemande,
