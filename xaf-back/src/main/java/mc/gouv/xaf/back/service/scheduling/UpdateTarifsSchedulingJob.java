...
/**
 * @author XDECOOL.EXT
 * Job permattant de mettre à jour un tarif en fonction de sa clef
 * Le cron de déclenchement est quant à lui spécifier dans la configuration propre à chaque besoin
 *
 */
