...
public class HTMLEscapeUtils {
    ...
    private static final String[][] HTML_ESCAPE_CHARS = { { ";", "&semi;" } // ; - semicolon
    };

    public static final CharSequenceTranslator ESCAPE_HTML = new AggregateTranslator(
            new LookupTranslator(EntityArrays.BASIC_ESCAPE()), new LookupTranslator(EntityArrays.ISO8859_1_ESCAPE()),
            new LookupTranslator(EntityArrays.HTML40_EXTENDED_ESCAPE()), new LookupTranslator(HTML_ESCAPE_CHARS));
