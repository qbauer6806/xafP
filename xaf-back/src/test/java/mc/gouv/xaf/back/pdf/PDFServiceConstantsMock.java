...
public class PDFServiceConstantsMock {
    ...
    public static final String CURRENT_DATE = "06/03/2019";
    ...
    public static final String DEPOSITE_DATE = "01/03/2019";
    ...
    public static final String RAISON_SOCIAL = "Société Test";
