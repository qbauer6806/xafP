...
updateTypedocJSON = (event) => {
    ...
    document.getElementById(idEvent).title = idToUpdateObj.options[idToUpdateObj.selectedIndex].title;
}
...
var execEnregistrerFichiers = function () {
    ...
    $("#typedoc-complements-checkbox").prop('value', JSON.stringify(complementsCheckbox));
...
var setCurrentPopup = function (previewButton) {
    ...
    document.getElementById(previewButton.id).setAttribute('disabled', 'disabled');
