...
public enum MailSupportEnum {
    ...
    XAF_ADRESSES_MAIL_SUPPORT_TECHNIQUE,
    XAF_ADRESSES_MAIL_SUPPORT_TECHNIQUE_RESID,
    XAF_ADRESSES_MAIL_SUPPORT_TECHNIQUE_CIR,
    XAF_ADRESSES_MAIL_SUPPORT_TECHNIQUE_RIO;
}
